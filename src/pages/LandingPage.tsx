...
const features = [
  {
    ...
    description: "Our AI extracts all key information from your resume automatically with industry-leading accuracy.",
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8">
              <div className="flex h-16 md:h-20 items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-4">
                  <Link to="/login">
                    <Button variant="ghost" className="hover:bg-white/5 font-medium relative overflow-hidden group">
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex items-center">
                      ...
                      <span className="text-xs font-medium text-purple-300">Just launched new AI features</span>
                    </div>
                  </motion.div>
                  ...
                  <div className="overflow-hidden mb-8">
                    ...
                    >
                      ...
                      <motion.div
                        initial={{ y: 80 }}
                        animate={{ y: 0 }}
                        transition={{ duration: 0.8, delay: 0.65, ease: [0.33, 1, 0.68, 1] }}
                        className="overflow-hidden mt-2"
                      >
                        <div className="relative inline-block">
                          <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">resume</span>
                          <motion.div 
                      ...
                      >
                        <div className="relative inline-block">
                          <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">winning profile</span>
                          <motion.div 
                            className="absolute bottom-0 left-0 w-full h-[4px] bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 rounded-full"
                            initial={{ scaleX: 0, originX: 0 }}
                            animate={{ scaleX: 1 }}
                  ...
                  >
                    ...
                    <Link to="/demo">
                      <button className="group relative inline-flex items-center justify-center px-8 py-4 md:py-5 overflow-hidden rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 text-white border border-white/10 font-medium transition-all duration-300 hover:border-white/20">
                        <span className="absolute inset-0 w-0 bg-gradient-to-r from-purple-600/10 to-blue-600/10 transition-all duration-300 ease-out group-hover:w-full"></span>
                  ...
                  >
                    <div className="flex -space-x-1.5">
                      {[...Array(3)].map((_, i) => (
                        ...
                        >
                          ...
                          <div className="absolute inset-0 rounded-full bg-gradient-to-br from-purple-500 to-blue-500"></div>
                          <span className="relative z-10">{String.fromCharCode(65 + i)}</span>
                        </motion.div>
                      ))}
                    </div>
                    <motion.span
                    ...
                    >
                      Join <span className="text-white font-medium">5,000+</span> professionals already using HuntShot
                    </motion.span>
                  </motion.div>
                </motion.div>
                      ...
                      <div className="relative h-full w-full overflow-hidden">
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <div className="text-xs text-white/80 font-medium">Profile score: 92%</div>
                          </div>
                        </motion.div>
                        ...
                        >
                          ...
                          <p className="text-sm text-white/80">
                            "HuntShot transformed my resume into an impressive profile that landed me interviews at top tech companies."
                          </p>
                        </motion.div>
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-xs font-medium text-purple-300">Exclusive Features</span>
                  </div>
                </motion.div>
                ...
                >
                  Everything you need for a <span className="relative inline-block">
                    <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">perfect profile</span>
                    <motion.span 
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-purple-300">AI-Powered Analysis</span>
                    </motion.div>
                    ...
                    >
                      Our advanced AI extracts key information from your resume, organizing your experience, 
                      skills, and achievements into a structured profile that stands out to recruiters.
                    </motion.p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm">
                          ...
                          <div className="text-xs text-white/60">12 extracted</div>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm">
                          ...
                          <div className="text-xs text-white/60">5+ years recognized</div>
                        </div>
                      </div>
                    </motion.div>
              ...
              <div className="text-center mb-20">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-xs font-medium text-purple-300">Simple Process</span>
                  </div>
                </motion.div>
                ...
                <div className="overflow-hidden mb-6">
                  ...
                  >
                    How <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">HuntShot</span> Works
                  </motion.h2>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-8 relative">
                  {[
                    ...
                    },
                    {
                      ...
                      icon: <div className="p-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white"><path d="M12 12.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"></path><path d="M16.5 19a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z"></path><path d="M3 9a3 3 0 0 1 6 0m0 0a3 3 0 1 0 6 0m0 0a3 3 0 1 0 6 0"></path></svg>
                      </div>
                    },
                    {
                      step: "03",
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-b from-white/[0.09] to-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden">
                  ...
                  <div className="relative text-center mb-10 max-w-3xl mx-auto">
                    ...
                    >
                      Ready to elevate your <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">career?</span>
                    </motion.h2>
                    ...
                    <motion.p 
                      ...
                      className="text-xl text-white/70 max-w-2xl mx-auto"
                    >
                      Join thousands of professionals who have transformed their job search with HuntShot
                    </motion.p>
                  </div>
                  ...
                  >
                    ...
                    <Link to="/demo">
                      <Button 
                        variant="outline" 
                        size="lg" 
                        className="border-white/20 hover:bg-white/5 text-lg py-6 px-8 w-full sm:w-auto relative overflow-hidden group"
                      >
                        <span className="relative z-10">View Demo</span>
                  ...
                  <div className="mt-10 flex flex-col md:flex-row items-center justify-center gap-4 text-white/50 text-sm">
                    <div className="flex items-center">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-6 mb-12">
                <div className="col-span-2 md:col-span-1">
                  ...
                  <p className="text-sm text-white/50 mb-4 max-w-xs">
                    The intelligent resume and profile management platform for modern professionals.
                  </p>
                </div>
                
                <div>
                  <h3 className="font-medium mb-4 text-sm uppercase tracking-wider text-white/40">Product</h3>
                  <ul className="space-y-3 text-sm">
                    ...
                    <li><Link to="/templates" className="text-white/70 hover:text-white transition-colors">Templates</Link></li>
                  </ul>
                </div>
                
                <div>
                  <h3 className="font-medium mb-4 text-sm uppercase tracking-wider text-white/40">Company</h3>
                  <ul className="space-y-3 text-sm">
                ...
                <div>
                  <h3 className="font-medium mb-4 text-sm uppercase tracking-wider text-white/40">Legal</h3>
                  <ul className="space-y-3 text-sm">
              ...
              <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p className="text-sm text-white/40 mb-4 md:mb-0">
                  &copy; {new Date().getFullYear()} HuntShot. All rights reserved.
                </p>
                <div className="flex space-x-6">
                  {['Twitter', 'LinkedIn', 'GitHub'].map((item, i) => (
                    <a key={i} href="#" className="text-white/40 hover:text-white transition-colors text-sm">
                      {item}
                    </a>
                  ))}
                </div>
